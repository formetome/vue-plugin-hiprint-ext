  ...
  function (t, e, n) {
    ...
    var i = (function () {
      ...
      subField = (function () {
        ...
        return (
          (t.prototype.createTarget = function (t) {
            var fields = (t && t.getFields()) || []
            var subFields = fields.filter((p) =>
              p.field.startsWith(t.options.field + '.')
            )
        ...
        return (
          ...
          (e.prototype.getData = function (t) {
            ...
            if (
              e &&
              typeof e === 'object' &&
              this.options.subField &&
              this.options.subField.length
            ) {
              var prefix = this.options.field + '.'
              var val
              if (Array.isArray(e)) {
                val = []
                e.forEach((item) => {
                  var valItem = {}
                  this.options.subField.forEach((key) => {
                    var strKey = key.substring(
                      key.indexOf(prefix) + prefix.length
                    )
                    valItem[strKey] = item[strKey]
                  })
                  val.push(valItem)
                })
              } else {
          ...
          (e.prototype.onResize = function (e, n, i, o, r) {
            ...
            ;('barcode' != this.options.getTextType() &&
              ...
              'dmcode' != this.options.getTextType()) ||
